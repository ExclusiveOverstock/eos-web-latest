...
const TERMS = [
  ...
  ["Return postage", `Paid by ${POLICY.returnPostage}`],
          ...
          <Reveal>
            <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="eos-display-sm mt-4 max-w-[30ch] text-[1.35rem] text-bone sm:text-[1.8rem]">
                  Message us with your order number and we will tell you where
                  to send it.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Link href="/shop" className="eos-btn eos-btn-quiet">
